<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HS-Profile.aspx.cs" Inherits="HS_Profile" %>
...
<form id="form2" runat="server">
    <div>
        ...
        <asp:Label ID="Label3" runat="server" Font-Bold="True" >Category:</asp:Label></td>
                         <td>
        <asp:label ID="TextBox1" runat="server">Demo</asp:label>
           </td>
                         </tr>
                     <tr>
                <td  >
                         ...
                         <td>
        <asp:label  ID="TextBox2" runat="server">Demo</asp:label>
                    </td>
                         </tr>
        ...
        <asp:Label ID="Label5" runat="server" Font-Bold="True" >Year Qualified :</asp:Label></td>
                         <td class="auto-style3">
        <asp:label  ID="TextBox3" runat="server">Demo</asp:label>
        </td></tr>
        ...
        <asp:label ID="ListBox1" runat="server"  Width="573px">Demo</asp:label>
            ...
            <tr>
                ...
                <td align="center" colspan="2">
                     <asp:Label ID="Label2" runat="server" Text="Your Applied Jobs " ForeColor="#0C334E" Font-Bold="True" Font-Size="Large" ></asp:Label>
...
<ItemStyle Width="120px"></ItemStyle>
    ...
    <asp:BoundField DataField="dateapplied" HeaderText="Date Applied" ItemStyle-Width="120" NullDisplayText="DEMO COUNTRT" >
<ItemStyle Width="120px"></ItemStyle>
    </asp:BoundField> 
     <asp:TemplateField>
   <ItemTemplate>
...
<SortedDescendingHeaderStyle BackColor="#6F8DAE" />
        ...
        <p >
          ...
          <asp:Button ID="Button2" runat="server" OnClick="Msges" Text="Messages" class="btn btn-primary btn-lg" Font-Size="Small" OnClientClick="return ConfirmOnDelete('');" />
            <asp:Button ID="Button3" runat="server" OnClick="searchJob" Text="Search Job" class="btn btn-primary btn-lg" Font-Size="Small"  />
              </p>
    <br />
    <br />    <!-- Promos -->
